    ...
    <div className="min-h-screen bg-[var(--color-educar-light)] flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-lg border border-gray-100 p-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-[var(--color-educar-dark)]">Acceso Administrativo</h2>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[var(--color-educar-burgundy)] focus:border-transparent outline-none transition-all"
