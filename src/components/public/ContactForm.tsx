      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          >
            ...
            <option value="Formación para el trabajo">Formación para el trabajo y desarrollo humano</option>
            <option value="Educación continua">Educación informal o continua</option>
          </select>
          {errors.programa_interes && <p className="text-red-500 text-sm mt-1">{errors.programa_interes.message}</p>}
        </div>
